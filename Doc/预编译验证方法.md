...
### 生成文件
编译成功后会在`MDK-ARM/Three-channel controller_v4.0/`目录下生成：
...
### 生成文件清单
```
Three-channel controller_v4.hex    (85KB)  - 主烧写文件
Three-channel controller_v4.map    (332KB) - 内存映射
Three-channel controller_v4.0      (799KB) - 可执行文件
Three-channel controller_v4.htm    (162KB) - HTML报告
```
